...
const styles: Record<string, React.CSSProperties> = {
  ...
  bubble: { maxWidth: "72%", padding: "0.75rem 1rem", lineHeight: 1.55 },
  bubbleSarah: { background: "white", border: "1px solid #efe9e0", borderTopLeftRadius: 14, borderTopRightRadius: 14, borderBottomLeftRadius: 2, borderBottomRightRadius: 14, boxShadow: "0 1px 6px rgba(13,17,23,0.06)" },
  bubbleYou: { background: "linear-gradient(135deg, #1a1f2e, #2d3548)", color: "white", borderTopLeftRadius: 14, borderTopRightRadius: 14, borderBottomLeftRadius: 14, borderBottomRightRadius: 2, boxShadow: "0 1px 6px rgba(13,17,23,0.2)" },
